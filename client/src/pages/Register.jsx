...
export default function Register() {
    ...
    const bubbles = [
        { size: 200, top: '8%', left: '5%', delay: '0s', duration: '20s', opacity: 0.14 },
        { size: 160, top: '70%', left: '8%', delay: '2s', duration: '18s', opacity: 0.12 },
        { size: 300, top: '10%', right: '2%', delay: '1s', duration: '22s', opacity: 0.09 },
        { size: 90, top: '80%', right: '10%', delay: '4s', duration: '15s', opacity: 0.2 },
        { size: 60, top: '35%', left: '30%', delay: '3s', duration: '13s', opacity: 0.22 },
        { size: 170, top: '88%', left: '60%', delay: '5s', duration: '25s', opacity: 0.07 },
        { size: 45, top: '18%', left: '70%', delay: '6.5s', duration: '11s', opacity: 0.28 },
        { size: 140, top: '55%', right: '20%', delay: '7.5s', duration: '17s', opacity: 0.14 },
    ];
        ...
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0a0015 0%, #1a0030 25%, #0d001a 50%, #15002b 75%, #0a0015 100%)' }}>
            ...
            <div className="relative z-10 w-full max-w-md mx-4" style={{ animation: 'fadeUp 0.8s ease-out' }}>
                ...
                <div className="rounded-[28px] p-10 flex flex-col items-center" style={glass}>
                    ...
                    {/* Title */}
                    <h2 className="text-3xl font-extrabold mb-2 text-center text-white">Create Account</h2>
                    <p className="text-gray-500 text-sm mb-8">Join NexusAI and start your journey</p>
                    ...
                    <form onSubmit={handleSubmit} className="w-full space-y-5">
                        <div>
                            <label className="block mb-2 text-[10px] font-bold text-gray-500 uppercase tracking-widest px-1">Username</label>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-500 font-medium">
                        ...
                        <Link to="/login" className="font-bold hover:underline" style={{ color: '#c084fc' }}>Sign In</Link>
                    </p>
                </div>
            </div>
        </div>
